...
import {
  ...
  BarChart3, LogOut, Brain, Shield, User, Cpu, Network
} from 'lucide-react'
...
const componentItems = [
  { to: '/component1', icon: Cpu,     label: 'Component 1',  sub: 'Response Generation', color: 'indigo' },
  { to: '/component2', icon: Network, label: 'Component 2',  sub: 'Topic Modeling',       color: 'purple' },
]
      ...
      <aside className="w-64 bg-white border-r border-gray-100 flex flex-col shadow-sm">
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          ...
          <div className="pt-3 pb-1">
            <p className="text-xs font-bold uppercase tracking-wider text-gray-400 px-3 mb-2">
              Research Components
            </p>
            {componentItems.map(({ to, icon: Icon, label, sub, color }) => (
              <NavLink
                key={to}
                to={to}
                className={({ isActive }) =>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs opacity-60 leading-tight">{sub}</p>
                </div>
              </NavLink>
            ))}
          </div>
