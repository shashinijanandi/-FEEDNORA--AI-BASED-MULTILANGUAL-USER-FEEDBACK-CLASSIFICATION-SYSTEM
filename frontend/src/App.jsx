...
import Component1Page from './pages/Component1'
import Component2Page from './pages/Component2'
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
        ...
        <Route path="component1" element={<Component1Page />} />
        <Route path="component2" element={<Component2Page />} />
